...
const  submitAmount=(homeTeam,awayTeam,date)=>{
  ...
  return(
     ...
     <Card
      className={cn(
        "relative m-3  w-[400px] backdrop-blur-sm border-border/50 bg-gradient-to-br from-card/90 to-card/50 hover:shadow-glow transition-all duration-300 animate-slideUp",
