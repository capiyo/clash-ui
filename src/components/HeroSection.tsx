...
export default function HeroSection() {
 ...
 <div className=" hidden md:flex ">
      {/* Welcome Section */}
      <div className="bg-[#300669] rounded-2xl p-8 text-primary-foreground shadow-elevated ">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2"> clash and have fun</h1>
            <p className="text-primary-foreground/90 text-lg">
             clash against your peer, place bets and earn, no more debates just bets
            </p>
          </div>
